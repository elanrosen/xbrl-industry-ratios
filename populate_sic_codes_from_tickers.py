...
def process_csv_with_xbrl_api(file_path):
...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python sic_json_populator.py <input_csv_file> <output_json_file>")
        sys.exit(1)
    ...
    sic_code_dict = process_csv_with_xbrl_api(input_csv_file)
